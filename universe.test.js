...
assert.equal(isSyntheticNonCrypto("SPX500USDT"), true);
assert.equal(isSyntheticNonCrypto("SPYUSDT"), true);
assert.equal(isSyntheticNonCrypto("SOXLUSDT"), true);
...
const contracts = [
  ...
  { symbol: "UNKNOWN_USDT", state: 0, apiAllowed: true, typeLabel: 2, contractSize: 1, minVol: 1, volUnit: 1 },
];
const tickers = [
  { symbol: "BTC_USDT", amount24: 10000000, lastPrice: 100000 },
  { symbol: "OILBRENT_USDT", amount24: 20000000, lastPrice: 100 },
  { symbol: "UNKNOWN_USDT", amount24: 30000000, lastPrice: 100 },
];
